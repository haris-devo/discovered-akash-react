...
const AccordionDataCustomize = () => {
  ...
  const updateStarMapFill = (color, type) => {
    console.log(type);
    updateState({
      type: "STAR_MAP_COLORS",
      payload: { ctype: type, cvalue: color },
    });
  };
                  ...
                  state.texts.map((t, index) => {
                    return (
                      <textarea
                        ...
                        title={
                          index == 0
                            ? "Main text can't be longer then 15 characters"
            ...
            <Typography sx={{ wordWrap: "break-word" }}>
              <div className="flex flex-col gap-3 py-2 w-full max-h-auto h-28 overflow-y-auto ">
                  ...
                  {state.texts.map((t, index) => {
                    return (
                      <button
                        ...
                        className={
                          selectedText == index
                            ? " rounded-lg py-1.5 px-5 bg-gradient-new text-white text-xs font-thin shadow-xl"
                            : " rounded-lg py-1.5 px-5 text-black text-xs font-thin shadow-xl"
                        }
                      >
                        {index == 0 ? "Main text" : "Text " + index + 2}
                      </button>
                ...
                <div className="flex w-full justify-around px-10 py-2">
                  <button
                    onClick={() => updateTextStyle("Georgia")}
                    className=" rounded-lg py-1.5 px-2  text-black text-xs font-bold font-sans"
                  >
                    Georgia
                  </button>
                  <button
                    onClick={() => updateTextStyle("Arial")}
                    className=" rounded-lg py-1.5 px-2  text-black text-xs font-bold font-inter"
                  >
                    Arial
                  </button>
                  <button
                    onClick={() => updateTextStyle("Monaco")}
                    className=" rounded-lg py-1.5 px-2  text-black text-xs font-bold font-serif"
                  >
                    Monaco
                  </button>
                </div>
            ...
            <Typography sx={{ wordWrap: "break-word" }}>
              <div className="flex flex-col gap-3 py-2 w-full max-h-auto h-72 overflow-y-auto ">
                ...
                <div className="flex w-full justify-center mt-2">
                  ...
                  <button
                    onClick={() => setSelectedStarFill(0)}
                    className={
                      selectedStarFill == 0
                        ? " rounded-lg py-2 px-5 bg-gradient-new  text-black text-xs font-500 shadow-xl"
                        : " rounded-lg py-2 px-5   text-black text-xs font-500 shadow-xl"
                    }
                  >
                    Background Color
                ...
                <div className="flex w-full space-x-2">
                  <button
                    onClick={() =>
                      updateStarMapFill(
                        "#21618C",
                        selectedStarFill == 0 ? "bgcolor" : "starcolor"
                      )
                    }
                    className=" rounded-lg p-5 px-10 bg-blue-300 border border-blue-700 text-white text-xs font-thin shadow-xl"
                  ></button>
                  <button
                    onClick={() =>
                      updateStarMapFill(
                    ...
                    className=" rounded-lg p-5 px-10 bg-red-700  text-black text-xs font-thin shadow-xl"
                  ></button>
                  <button
                    onClick={() =>
                      updateStarMapFill(
                    ...
                    className=" rounded-lg p-5 px-10 bg-black  text-black text-xs font-thin shadow-xl"
                  ></button>
                </div>
              </div>
            </Typography>
                  ...
                  <div className="flex flex-col gap-2 pl-10">
                    <div className="flex space-x-2 items-center">
                      <input
                        ...
                        onClick={() =>
                          updateStreetMap(
                            "labels",
                            state.streetmap[0].stylers[0].visibility == "on"
                              ? "off"
                              : "on",
                            "elementType",
                            "visibility"
                    ...
                    <div className="flex w-full justify-center mt-2">
                      {state.streetmap.map((s, index) => {
                        if (s.elementType.includes("fill"))
                          return (
                            <button
                              onClick={() => setSelectedStreetFill(index)}
                              className={
                                selectedStreetFill == index
                                  ? " rounded-lg py-2 px-5 bg-gradient-new  text-black text-xs font-500 shadow-xl"
                                  : " rounded-lg py-2 px-5   text-black text-xs font-500 shadow-xl"
                              }
                            >
                    ...
                    <div className="flex w-full space-x-2">
                      <button
                        onClick={() =>
                          updateStreetMap(
                            state.streetmap[selectedStreetFill].featureType,
                            "#21618C",
                            "featureType",
                            "color"
                          )
          ...
          <AccordionDetails className="border-0 shadow-none">
            <Typography sx={{ wordWrap: "break-word" }}>
              <div className="flex flex-col gap-3 py-2 w-full max-h-auto h-44 overflow-y-auto ">
                  ...
                  {state.shapes.map((s, index) => {
                    return (
                      <button
                        className={
                          selectedFill === index
                            ? "rounded-lg py-2 px-5 bg-gradient-new text-white text-xs font-thin shadow-xl mx-2"
                            : "rounded-lg py-2 px-5 text-black text-xs font-thin shadow-xl mx-2"
                        }
                        style={{ width: "100px" }}
                ...
                <div className="flex w-full space-x-2">
                  <button
                    onClick={() => updateFill("blue")}
                    className=" rounded-lg p-5 px-10 bg-blue-800 border border-blue-100 text-white text-xs font-thin shadow-xl"
                  ></button>
                  <button
                    onClick={() => updateFill("red")}
                    className=" rounded-lg p-5 px-10 bg-red-900  text-black text-xs font-thin shadow-xl"
                  ></button>
                  <button
                    onClick={() => updateFill("green")}
                    className=" rounded-lg p-5 px-10 bg-green-900  text-black text-xs font-thin shadow-xl"
                  ></button>
                </div>
              </div>
            </Typography>
