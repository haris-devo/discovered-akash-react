...
!(function () {
  ...
  function L(t) {
    ...
    var M = v.append("div").attr("class", "ctrl"),
      b = M.append("form")
        ...
        .attr("method", "get")
        .attr("action", "#"),
      w = b.append("div").attr("class", "col").attr('style',"display:none !important");
    w
      .append("label")
  ...
  function download(d3,J){
    document.getElementById('planets-show').checked
    var t = d3.select("body").append("a").node(),
    ...
    function l() {
      ...
      if (
        ...
        (p = tt.getPoint(vt.inverse(a, [90, 0], u), y.transform)),
          (p[2] = 0),
          "zenith" === y.follow ? tt.rotate({ center: p }) : tt.redraw(); download(d3,J) 
      }
    }
    function c(t, e) {
